<div align="center">
  <img src="site/assets/github-academy-showcase.svg" alt="ASAIAS academy showcase" width="100%" />
  ...
  <p>
    <img alt="Status: public pilot" src="https://img.shields.io/badge/status-public%20pilot-163e5a?style=for-the-badge" />
    <img alt="Focus: AI governance" src="https://img.shields.io/badge/focus-AI%20governance-087f82?style=for-the-badge" />
    <img alt="Route: course demo review" src="https://img.shields.io/badge/route-course%20%7C%20demo%20%7C%20review-3c7456?style=for-the-badge" />
    <img alt="Language: RU first EN next" src="https://img.shields.io/badge/language-RU%20first%20%7C%20EN%20next-b27633?style=for-the-badge" />
  </p>
</div>
...
```mermaid
flowchart LR
  A["Start Here"] --> B["Course 01"]
  B --> C["Demo 01"]
  C --> D["Evidence"]
  D --> E["Review"]
  E --> F["Certificate Path"]
  A --> G["Student Intake"]
  G --> H["CRM Card"]
  H --> E
  I["Research Bulletin"] --> B
  J["Financial Model"] --> G
  K["Governance"] --> E
```
